...
class AddStudent(Frame):
    ...
    def __init__(self, parent):
        ...
        canvas.create_text(62.0, 35.0, anchor="nw", text="Add student", fill="#FFFFFF",
        ...
        canvas.create_text(23.0, 285.0, anchor="nw", text="Last name", fill="#FFFFFF",
        ...
        canvas.create_text(661.0, 285.0, anchor="nw", text="Middle name", fill="#FFFFFF",
                           font=("LexendDeca Regular", 14 * -1))
        ...
        canvas.create_text(23.0, 397.0, anchor="nw", text="Email Address", fill="#FFFFFF",
                           font=("LexendDeca Regular", 14 * -1))
        ...
        canvas.create_text(23.0, 509.0, anchor="nw", text="Contact Number", fill="#FFFFFF",
                           font=("LexendDeca Regular", 14 * -1))
